...
var BodyView = require("./common/views/body"),
    HomeView = require("./common/views/home"),
    InfoView = require("./common/views/info"),
    RobotIndexView = require("./robot/views/index"),
    RobotAddView = require("./robot/views/add"),
    RobotEditView = require("./robot/views/edit"),
    RobotDetailView = require("./robot/views/detail");

var RobotDetailComponent = require("./robot/components/detail");
...
//      model: me,
  ...
  detailRobot: function(id) {
    var model = this.bodyView.robots.get(id);
    React.render(<RobotDetailComponent model={model}/>);

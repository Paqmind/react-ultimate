...
// IMPORTS
var fs = require("fs"), path = require("path"), http = require("http"), cp = require("child_process"), express = require("express"), io = require("socket.io"), ss = require("socket.io-stream"), favicon = require("serve-favicon"), logger = require("morgan"), cookieParser = require("cookie-parser"), bodyParser = require("body-parser"), conf = require("config");

var router = require("./router"), templater = require("./templater");
...
// SOCKET-IO ---------------------------------------------------------------------------------------
var exec = cp.exec, spawn = cp.spawn;
